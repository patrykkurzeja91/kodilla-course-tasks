        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'user' },
                    React.createElement('img', { className: 'avatar', src: this.props.user.avatar_url }),
                    React.createElement(
                        'a',
...
var UsersList = function (_React$Component2) {
    ...
    _createClass(UsersList, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'users row text-center' },
                this.users
            );
        }
    }, {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('input', { type: 'text', id: 'searchText', onChange: function onChange(event) {
                        ...
                        }, placeholder: 'Search on GitHub', value: this.state.searchText })
                ),
